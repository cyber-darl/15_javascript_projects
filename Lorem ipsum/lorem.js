...
const text = [
  ...
  form.addEventListener('submit', function(e){
    //form has a default behaviour, so prevent default
    e.preventDefault();
    //All input(including type=number) return a string, in the console, strings are black, while numbers are color blue.
...
if(isNaN(value) || value <= 0 || value > 9){
  ...
  let tempText = text.slice(0,value);// not including the value
